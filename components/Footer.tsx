...
const Footer = () => {
    return (
        <>
            <div className="w-full h-auto aspect-[900/200] bg-cover bg-center bg-no-repeat bg-[url('/img/background/footer-bg-light.svg')] dark:bg-[url('/img/background/footer-bg-dark.svg')]"></div>
